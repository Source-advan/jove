...
.."🏅 *setrules* = `تنظيم قوانين`\n"
	...
	.."🏅 `شما میتونید از ` *!*,*/*,*#* `یا حتی بدون این علائم برای ارسال دستور استفاده کنید`\n"
        .."🏅Channel:  @SCORPIONTGBOT"
        tdcli.sendText(chat_id, msg.id_, 0, 1, nil, text, 1, 'md')
      end
if input:match("^[#!/][Ss]corpoin$") and is_mod(msg) or input:match("^[Ss]corpoin$") and is_mod(msg) or input:match("^عقرب$") and is_mod(msg) then
        local text = "🏅 خداي SCORPION ورژن 8.0: \n"
	.." SCORPION رباتي قدرتمند جهت مديريت سوپرگروه: \n"
        ...
        .."🏅  ديباگ شده و قدرتمند \n"
        .."🏅  ويرايش و ارتقا: @Wow_heh \n"
        .."🏅  کانال رسمي: @SCORPIONTGBOT \n"
        .."🏅  پيام رسان: @Wow_heh_Bot \n"
        .."🏅 پشتيباني: @Wow_heh \n"
        .." ................................. "
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, text, 1, 'md')
      end
